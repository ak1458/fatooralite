    ...
    <div style={{ maxWidth: 800, margin: "40px auto", padding: "0 24px", color: "var(--tx)", fontFamily: "sans-serif" }}>
      ...
      <div style={{ lineHeight: 1.6, display: "flex", flexDirection: "column", gap: 18, fontSize: 14.5 }}>
        <section>
          ...
          <p>Signed invoice XML, QR codes, hash-chain data, and ZATCA gateway submission/clearance records are tax and audit records, not user content — they are retained for [placeholder: the retention period required for Saudi VAT record-keeping] even if you close your account, since deleting them could leave your business unable to demonstrate compliance in a ZATCA audit.</p>
        </section>

        <section>
          <h2 style={{ fontSize: 18, fontWeight: 600, margin: "0 0 8px" }}>2. Account & company profile data</h2>
          <p>Your business profile, user accounts, and application settings are retained for as long as your account is active. On account deletion, this data is removed within [placeholder: number] days, except where retained for the compliance-record reasons in §1 or a legal obligation.</p>
        </section>
